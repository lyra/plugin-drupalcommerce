...
namespace Drupal\commerce_payzen\Includes\Form;
...
class Request
{
     ...
     *
     * @var array[string][Drupal\commerce_payzen\Includes\Form\Field]
     * @access private
     */
     ...
     *
     * @param array[string][Drupal\commerce_payzen\Includes\Form\Field] $fields already filtered fields list
     * @param bool $hashed
     * @return string
     */
     ...
     *
     * @return array[string][Drupal\commerce_payzen\Includes\Form\Field] a list of fields
     */
