...
class Api
{
     ...
     *
     * @return array[int][Drupal\commerce_payzen\Includes\Form\Currency]
     */
     ...
     *
     * @param string $alpha3
     * @return \Drupal\commerce_payzen\Includes\Form\Currency|null
     */
    public static function findCurrencyByAlphaCode($alpha3)
    {
        ...
        foreach ($list as $currency) {
            /**
             * @var \Drupal\commerce_payzen\Includes\Form\Currency $currency
             */
